...
import type { AdminSubscriptionRow, PlatformMetrics } from "@/lib/database.types";
...
export default async function AdminBillingPage() {
  ...
  const metrics = metricsData as PlatformMetrics | null;
  const subscriptions = (subRows ?? []) as AdminSubscriptionRow[];

        ...
        <form ref={formRef} action={formAction} className="grid gap-4">
          ...
          <div className="grid gap-2">
            ...
            <select
              ...
              required
              defaultValue=""
              className="bg-background border-input h-10 rounded-md border px-3 text-sm shadow-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
            >
